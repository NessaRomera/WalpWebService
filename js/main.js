(function(){
  ...
  $document.ready(function () {
          ...
          if(!contactFormInput.parent().hasClass("input-error") && contactFormInput.val()){
            $.ajax({
              ...
              success: function() {
                ...
                contactResault.html("Mensagem enviada com sucesso!");
                setTimeout(function(){
            ...
            contactResault.html("Você deve preencher todos os campos obrigatórios");
            setTimeout(function(){
              contactResault.removeClass("incorrect").removeClass("correct");
            }, 4500);
          }
    ...
    $.ajaxChimp.translations.cm = {
      'enviar': 'Enviar...',
      0: 'Nós lhe enviamos um e-mail de confirmação',
      1: 'Digite um valor',
      2: 'Um endereço de e-mail deve conter um único @',
      3: 'A parte de domínio do endereço de e-mail é inválida (a parte após o @: )',
      4: 'A parte de nome de usuário do endereço de e-mail é inválida (a parte antes do @:',
      5: 'Este endereço de e-mail parece falso ou inválido. Digite um endereço de e-mail real'
    };
